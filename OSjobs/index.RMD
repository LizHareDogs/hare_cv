...
DGdataFrame <-
    tribble(
		...
		"Philadelphia, PA", 
		c("Developed anew C-BARQ-behavior questionnaire for selection and study of detector dogs",
		...
		"Philadelphia, PA", 
		c("Calculated estimated breeding values (EBV) for selectively breeding odor detection dogs"),
...
CornellDataFrame <-
  tribble(
    ...
    c("Designed and taught distance education courses in canine and feline genetics",
